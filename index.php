...
<body>
    ...
    <section id="about">
        <div class="idinfo">
            <h1>Troy Sarinas</h1>
            <div class="idpic">
                <img src="Media/Mecutie.png">
            </div>
            <p><span>(Front End Dev)</span>
                <br>
            ...
            <div class="sociallinks">
                <div>
                    <a class="social-icon" href="https://twitter.com/_troysarinas">
                        <ion-icon name="logo-twitter"></ion-icon>
                    </a>
                </div>
                <div>
                    <a class="social-icon" href="https://www.facebook.com/3ez5troyiee/">
        ...
        <div class="idinfo">
            <h1>Adrian Quilaneta</h1>
            <div class="idpic">
                <img src="Media/AdrianPic.png">
            </div>
            <p>
                <span>(Back End Dev)</span>
                <br>
                Mythical Glory 800 pts highest
                <br>
                NASA Engineer for Jet Propulsion of CURIOUSITY Rover
                <br>
                Valorant Coach for Team Secret
            </p>
            <div class="sociallinks">
                <div>
                    <a class="social-icon" href="https://twitter.com/_troysarinas">
                ...
                <div>
                    <a class="social-icon" href="https://www.facebook.com/ian.quilanetaaa">
                        <ion-icon name="logo-facebook"></ion-icon>
                    </a>
                </div>
            </div>
        ...
        <div class="idinfo">
            <h1>Jerico Tinimbang</h1>
            <div class="idpic">
                <img src="Media/Jerichoimg.png">
            </div>
            <p>
                <span>(UI UX Emphasis)</span>
                <br>
                Computer Eng
                <br>
                Adobe Photoshop
            ...
            <div class="sociallinks">
                ...
                <div>
                    <a class="social-icon" href="https://www.facebook.com/jerichocarlotinimbang?mibextid=ZbWKwL">
                        <ion-icon name="logo-facebook"></ion-icon>
                    </a>
                </div>
            </div>
        ...
        <div class="idinfo">
            <h1>Wroniel Velasco</h1>
            <div class="idpic">
                <img src="Media/WronielVelasco.jpg">
            </div>
            <p><span>(Hardware)</span>
                <br>
                Bachelor of Science in Computer Engineering
                <br>
                Assemble & Disassemble of Computer units
                <br>
                Video & Photo editing
                <br>
                Knowledgeable in MS Office and ML
            </p>
            <div class="sociallinks">
                <div>
                    <a class="social-icon" href="https://twitter.com/_troysarinas">
                ...
                <div>
                    <a class="social-icon" href="https://www.facebook.com/Rons2.velasco1?mibextid=ZbWKwL">
                        <ion-icon name="logo-facebook"></ion-icon>
                    </a>
                </div>
            </div>
